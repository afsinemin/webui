...
@UntilDestroy()
@Component({
  selector: 'spdk-base-namespace-form',
  templateUrl: './spdk-base-namespace-form.component.html',
...
export class SPDKBaseNamespaceFormComponent implements OnInit, OnChanges {
  ...
  namespace = input<SPDKNamespace>();
  error = input<unknown>(null);

  submitted = output<SPDKNamespaceChanges>();
  ...
  ngOnChanges(changes: IxSimpleChanges<SPDKBaseNamespaceFormComponent>): void {
  ...
  ngOnInit(): void {
    if (this.namespace()) {
      this.form.patchValue({
        ...this.namespace(),
        device_type: this.namespace().device_type === SPDKNamespaceType.Zvol
  ...
  protected onSubmit(): void {
    ...
    this.submitted.emit({
      device_path: path,
      device_type: value.device_type === FormNamespaceType.Zvol ? SPDKNamespaceType.Zvol : SPDKNamespaceType.File,
