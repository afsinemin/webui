...
@UntilDestroy()
@Component({
  selector: 'spdk-subsystems-list',
  templateUrl: './spdk-subsystems-list.component.html',
  styleUrl: './spdk-subsystems-list.component.scss',
...
export class SPDKSubsystemsListComponent {
  ...
  readonly subsystemSelected = output<SPDKSubsystemDetails>();
  readonly dataProvider = input.required<ArrayDataProvider<SPDKSubsystemDetails>>();
  ...
  protected columns = createTable<SPDKSubsystemDetails>([
    ...
    uniqueRowTag: (row) => 'SPDK-subsys-' + row.name,
  ...
  protected expanded(subsys: SPDKSubsystemDetails): void {
